...
# 'Sketch2': 12 segments → Line/RadiusArc profile
...
with BuildSketch(_inclined_plane_2) as sk_Sketch2_2:
    with BuildLine():
        RadiusArc((31.4, -2.4664), (8.3092, -15.7978), -32.0)
        RadiusArc((8.3092, -15.7978), (5.3092, -20.994), 3.6659)
        RadiusArc((5.3092, -20.994), (5.3092, -47.6569), -32.0)
        RadiusArc((5.3092, -47.6569), (8.3092, -52.853), 3.6659)
        RadiusArc((8.3092, -52.853), (31.4, -66.1845), -32.0)
        RadiusArc((31.4, -66.1845), (37.4, -66.1845), 3.6659)
        RadiusArc((37.4, -66.1845), (60.4908, -52.853), -32.0)
        RadiusArc((60.4908, -52.853), (63.4908, -47.6569), 3.6659)
        RadiusArc((63.4908, -47.6569), (63.4908, -20.994), -32.0)
        RadiusArc((63.4908, -20.994), (60.4908, -15.7978), 3.6659)
        RadiusArc((60.4908, -15.7978), (37.4, -2.4664), -32.0)
        RadiusArc((37.4, -2.4664), (31.4, -2.4664), 3.6659)
