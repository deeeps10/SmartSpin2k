...
# 'Sketch10': 44 segments → Line/RadiusArc profile
_inclined_plane_1 = Plane(
    origin=Vector(12.0, 0.0, 0.0),
    x_dir=Vector(0.0, 1.0, 0.0),
    z_dir=Vector(1.0, 0.0, 0.0),
)
with BuildSketch(_inclined_plane_1) as sk_Sketch10:
    with BuildLine():
    ...
    _inc_edges_sk_Sketch10 = list(BuildSketch._get_context().pending_edges)
# Build inclined-plane face outside BuildSketch (bypasses BRepFill_Filling)
from OCP.BRepBuilderAPI import BRepBuilderAPI_MakeFace
_wire_sk_Sketch10 = Wire.combine(_inc_edges_sk_Sketch10)[0]
_wire_sk_Sketch10 = _wire_sk_Sketch10.moved(_inclined_plane_1.location)
_mkf_sk_Sketch10 = BRepBuilderAPI_MakeFace(_inclined_plane_1.wrapped, _wire_sk_Sketch10.wrapped, True)
_face_sk_Sketch10 = Face(_mkf_sk_Sketch10.Face())

# 'Sketch11': 2 segments → Line/RadiusArc profile
_inclined_plane_2 = Plane(
    origin=Vector(0.0, 0.0, 0.0),
    x_dir=Vector(0.0, -1.0, 0.0),
    z_dir=Vector(-1.0, -0.0, 0.0),
)
with BuildSketch(_inclined_plane_2) as sk_Sketch11_2:
    with BuildLine():
    ...
    _inc_edges_sk_Sketch11_2 = list(BuildSketch._get_context().pending_edges)
# Build inclined-plane face outside BuildSketch (bypasses BRepFill_Filling)
from OCP.BRepBuilderAPI import BRepBuilderAPI_MakeFace
_wire_sk_Sketch11_2 = Wire.combine(_inc_edges_sk_Sketch11_2)[0]
_wire_sk_Sketch11_2 = _wire_sk_Sketch11_2.moved(_inclined_plane_2.location)
_mkf_sk_Sketch11_2 = BRepBuilderAPI_MakeFace(_inclined_plane_2.wrapped, _wire_sk_Sketch11_2.wrapped, True)
_face_sk_Sketch11_2 = Face(_mkf_sk_Sketch11_2.Face())

# -- Build --
with BuildPart() as part:
    # --- FEATURE: Extrude10 ---
    # -- Extrude10 --
    _face = _face_sk_Sketch10
