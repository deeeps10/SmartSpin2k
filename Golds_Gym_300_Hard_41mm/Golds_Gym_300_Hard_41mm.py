...
# 'Sketch2': 16 segments → Line/RadiusArc profile
_inclined_plane_2 = Plane(
    origin=Vector(0.0, 0.4, 0.0),
    x_dir=Vector(1.0, 0.0, 0.0),
    z_dir=Vector(-0.0, 1.0, 0.0),
)
with BuildSketch(_inclined_plane_2) as sk_Sketch2_2:
    with BuildLine():
        RadiusArc((31.4946, -56.2196), (12.7062, -37.4313), 22.0)
        RadiusArc((12.7062, -37.4313), (13.4375, -35.5968), 2.0)
        RadiusArc((13.4375, -35.5968), (13.4375, -33.255), -1.5)
        RadiusArc((13.4375, -33.255), (12.7062, -31.4205), 2.0)
        RadiusArc((12.7062, -31.4205), (31.4946, -12.6322), 22.0)
        RadiusArc((31.4946, -12.6322), (33.3291, -13.3634), 2.0)
        RadiusArc((33.3291, -13.3634), (35.6709, -13.3634), -1.5)
        RadiusArc((35.6709, -13.3634), (37.5054, -12.6322), 2.0)
        RadiusArc((37.5054, -12.6322), (56.2937, -31.4205), 22.0)
        RadiusArc((56.2937, -31.4205), (55.5625, -33.255), 2.0)
        RadiusArc((55.5625, -33.255), (55.5625, -35.5968), -1.5)
        RadiusArc((55.5625, -35.5968), (56.2938, -37.4313), 2.0)
        RadiusArc((56.2938, -37.4313), (37.5054, -56.2196), 22.0)
        RadiusArc((37.5054, -56.2196), (35.6709, -55.4884), 2.0)
        RadiusArc((35.6709, -55.4884), (33.3291, -55.4884), -1.5)
        RadiusArc((33.3291, -55.4884), (31.4946, -56.2196), 2.0)
