...
with BuildPart() as part:
    ...
    # --- FEATURE: Fillet1 ---
    # -- Fillet1 --
    # Fillet radius=5.0mm  (expr: 5.000000 mm)  |  4 edge(s)
    ...
    # edge 0 vertices: [67.5, 61.0, 15.0] → [-67.5, 61.0, 15.0]
    # edge 1 vertices: [67.5, -61.0, 15.0] → [67.5, 61.0, 15.0]
    # edge 2 vertices: [-67.5, -61.0, 15.0] → [67.5, -61.0, 15.0]
    # edge 3 vertices: [-67.5, 61.0, 15.0] → [-67.5, -61.0, 15.0]
    try:
        # OCP-confirmed indices: [3, 6, 9, 11]
        # OCP-confirmed indices: [3, 6, 9, 11]
        fillet([part.edges()[3], part.edges()[6], part.edges()[9], part.edges()[11]], radius=5.0)
